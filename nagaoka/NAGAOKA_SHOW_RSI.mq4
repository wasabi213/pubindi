   ...
   for(i=pos; i<rates_total && !IsStopped(); i++)
     {
	  ...
	  //Print(diff>0.0?diff:0.0);
	  //Print(diff<0.0?-diff:0.0);

	  //printf("ExtPosBuffer[%d]:%3.5f",i,ExtPosBuffer[i]);
	  //printf("ExtNegBuffer[%d]:%3.5f",i,ExtNegBuffer[i]);
